...
include_once __DIR__."/../Module/SubscriptionModule.php";

class SubscriptionController extends SubscriptionModule
{
    ...
    public function checkPost($id,$subscriptionType){
         $sql = parent::checkPost($id,$subscriptionType);
    ...
    public function getService($id = ''){
      ...
      /**
     * @param string $id
     * @param string $Invatation
     * @param bool $not
     * @param string $limit
     * @return array
     */

    public function getSubscription($id = '',$type = ''){

        $user = parent::getPostSubscription($id,$type);
        $data = false;
