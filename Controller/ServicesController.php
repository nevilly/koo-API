...
include_once __DIR__."/../Module/ServicesModule.php";

class ServicesController extends ServicesModule
{
    ...
    public function checkPost($busnessId,$ceremonyId){
         $sql = parent::checkPost($busnessId,$ceremonyId);
    ...
    public function getInvatations($id = '',$type = ''){

        $user = parent::getPostInvatations($id,$type);
        $data = false;
