...
include_once __DIR__."/../Module/CeremonyModule.php";

class CeremonyController extends CeremonyModule
{
    ...
    public function getCeremonyUserIdFeeds($id = ''){

        $user = parent::geCeremonyByUserId($id);
        $data = false;
    ...
    public function getCeremonies($day = ''){

        $user = parent::getPostCeremonies($day);
        $data = false;
    ...
    public function getCeremoniesByTyp($d = ''){

        $user = parent::getCeremoniesByType($d);
        $data = false;
